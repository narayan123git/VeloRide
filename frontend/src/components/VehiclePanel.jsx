...
const VehiclePanel = (props) => {
  return (
    <div >
          ...
          className='flex mb-2 active:border-2 active:border-black bg-gray-100 rounded-xl w-full p-3 items-center justify-between'>
            <img className='h-12' src="https://w7.pngwing.com/pngs/253/459/png-transparent-yellow-taxi-art-taxi-amritsar-careem-bus-uber-yellow-car-compact-car-other-driving-thumbnail.png" alt="" />
            <div className='md:-ml-20 w-1/2'>
